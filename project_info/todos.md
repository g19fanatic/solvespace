...
| `project_info/subsystems/chamfer-fillet.md` | CHAMFER/FILLET group types, 7 helper functions + 3 test helpers, 16-step algorithm (Step 16: intermediate vertices on shared edge), DIFF internal RECON path, cap scoring by \|normal.Dot(t)\|, ASSEMBLE-skip fix, BridgeTrimGapIfOpen repair sweep, 77-test coverage summary (14 new fillet_diff_* tests), backface/origin-line regressions | ✅ Updated (Apr 7) |
